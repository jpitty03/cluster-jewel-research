...
export function generateCraftExplanation(
  ...
  lines.push('2. Historical Base Self-Fracture Fixture: Approximate Alteration/Augmentation/Regal plus an unmodeled lump-sum preparation allowance and a fixed 25% Fracturing Orb hit rate. This fixture does not model the standard Crafting Bench as a cluster-jewel target-modifier source and is not used by normal optimizer ranking.');
