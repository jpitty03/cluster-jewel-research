...
export const EXTERNAL_PARITY_OBSERVATIONS: ExternalParityObservation[] = [
  ...
  {
    benchmarkId: 'phase2j_harvest_defences_t1_armour_es',
    source: 'craft-of-exile',
    action: 'Harvest Reforge Defences',
    targetDescription: 'T1 Armour + T1 Maximum Energy Shield; extra affixes allowed',
    attempts: 32_917,
    successes: 98,
    observedProbability: 98 / 32_917,
    displayedRatio: '~1 / 336',
    notes: 'Phase 2J user-supplied observation. Physical base/enchantment/passive metadata was not present in the supplied evidence and must not be inferred.',
    fixtureMetadata: {
      startingRarity: 'rare',
      startingState: 'non-fractured; Harvest replaces non-fractured explicit affixes',
      fractureState: 'none / unfractured',
      completeness: 'INCOMPLETE',
    },
  },
  {
    benchmarkId: 'phase2j_conventional_alt_t1_armour_es',
    source: 'craft-of-exile',
    action: 'Orb of Alteration stage',
    targetDescription: 'Conventional T1 Armour + T1 Maximum Energy Shield policy',
    attempts: 42_728,
    successes: 1_507,
    observedProbability: 1_507 / 42_728,
    displayedRatio: '~1 / 29',
    notes: 'Phase 2J user-supplied stage row. Passed means the external recipe advanced from this stage; it is not a standalone final-craft probability.',
  },
  {
    benchmarkId: 'phase2j_conventional_regal_t1_armour_es',
    source: 'craft-of-exile',
    action: 'Regal Orb stage',
    targetDescription: 'Conventional T1 Armour + T1 Maximum Energy Shield policy',
    attempts: 1_507,
    successes: 14,
    observedProbability: 14 / 1_507,
    displayedRatio: '~1 / 108',
    notes: 'Conditional external stage row; never multiply it with unrelated displayed rows without matching recipe semantics.',
  },
  {
    benchmarkId: 'phase2j_conventional_exalt_t1_armour_es',
    source: 'craft-of-exile',
    action: 'Exalted Orb stage',
    targetDescription: 'Conventional T1 Armour + T1 Maximum Energy Shield policy',
    attempts: 1_507,
    successes: 30,
    observedProbability: 30 / 1_507,
    displayedRatio: '~1 / 51',
    notes: 'Conditional external stage row; the screenshot does not establish the exact incoming Rare-state mixture.',
  },
  {
    benchmarkId: 'phase2j_conventional_scour_t1_armour_es',
    source: 'craft-of-exile',
    action: 'Orb of Scouring recovery',
    targetDescription: 'Conventional T1 Armour + T1 Maximum Energy Shield policy',
    attempts: 1_477,
    successes: 1_477,
    observedProbability: 1,
    displayedRatio: '1 / 1',
    notes: 'Recovery-action accounting row, not a target-success probability.',
  },
  {
    benchmarkId: 'phase2j_conventional_transmute_t1_armour_es',
    source: 'craft-of-exile',
    action: 'Orb of Transmutation restart',
    targetDescription: 'Conventional T1 Armour + T1 Maximum Energy Shield policy',
    attempts: 1_477,
    successes: 1_477,
    observedProbability: 1,
    displayedRatio: '1 / 1',
    notes: 'Restart-action accounting row, not a target-success probability.',
  },
];
