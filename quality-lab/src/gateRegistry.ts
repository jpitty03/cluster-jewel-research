...
export const QUALITY_GATE_REGISTRY: QualityGateDefinition[] = [
  ...
  gate({
    id: 'A-phase3j-player-rule-direct',
    version: 1,
    phase: '3J',
    title: 'Modifier roles, contextual junk, certified grouping, and fail-closed player rules',
    tags: ['phase3j', 'craft-plan', 'policy-explanation', 'proof'],
    fixtureIds: [],
    costClass: 'FAST',
    isolation: 'SELF_CONTAINED',
    dependencies: [],
    sourceAreas: ['craft-plan', 'optimizer-service'],
    defaultSuites: ['DEV', 'RELEASE'],
    shard: 'A',
    operation: 'phase3j-player-rule-direct',
  }),
  gate({
    id: 'A-phase3k-guided-constellation-direct',
    version: 1,
    phase: '3K',
    title: 'Guided compiler ownership, baseline ancestry, fail-closed source contract, and forbidden-feature audit',
    tags: ['phase3k', 'guided-constellation', 'craft-plan', 'policy-flow', 'proof'],
    fixtureIds: [],
    costClass: 'FAST',
    isolation: 'SELF_CONTAINED',
    dependencies: ['A-phase3j-player-rule-direct'],
    sourceAreas: ['craft-plan', 'policy-flow', 'optimizer-service', 'optimizer-ui', 'share-bundle'],
    defaultSuites: ['DEV', 'RELEASE'],
    shard: 'A',
    operation: 'phase3k-guided-constellation-direct',
  }),
  gate({
    id: 'A-phase3l-ui-reliability-direct',
    version: 1,
    phase: '3L',
    title: 'Phase 3K freeze, focused scope, portal ownership, repair derivation, print contract, and release marker',
    tags: ['phase3l', 'optimizer-ui', 'guided-constellation', 'print', 'proof'],
    fixtureIds: [],
    costClass: 'FAST',
    isolation: 'SELF_CONTAINED',
    dependencies: ['A-phase3k-guided-constellation-direct'],
    sourceAreas: ['optimizer-ui', 'responsive-css', 'craft-plan', 'release-harness'],
    defaultSuites: ['DEV', 'RELEASE'],
    shard: 'A',
    operation: 'phase3l-ui-reliability-direct',
  }),
  gate({
  ...
  gate({
    id: 'B-phase3j-player-rule-worker',
    version: 1,
    phase: '3J',
    title: 'Real Worker certifies exhaustive strict player rules and exact evidence reconciliation',
    tags: ['phase3j', 'worker', 'solver', 'craft-plan', 'policy-explanation', 'proof', 'fracture'],
    fixtureIds: ['phase3c_primordial_renewal_rotten_claws'],
    costClass: 'SOLVER_HEAVY',
    isolation: 'SELF_CONTAINED',
    dependencies: ['A-phase3j-player-rule-direct'],
    sourceAreas: ['optimizer-service', 'craft-plan', 'worker'],
    defaultSuites: [],
    shard: 'B',
    operation: 'phase3j-player-rule-worker',
  }),
  gate({
    id: 'B-phase3k-guided-constellation-worker',
    version: 1,
    phase: '3K',
    title: 'Real Worker reconciles guided stages, exact evidence, recovery destinations, terminal truth, and frozen field counts',
    tags: ['phase3k', 'guided-constellation', 'worker', 'solver', 'craft-plan', 'policy-flow', 'proof', 'fracture'],
    fixtureIds: ['phase3c_primordial_renewal_rotten_claws'],
    costClass: 'SOLVER_HEAVY',
    isolation: 'SELF_CONTAINED',
    dependencies: ['A-phase3k-guided-constellation-direct'],
    sourceAreas: ['optimizer-service', 'craft-plan', 'policy-flow', 'worker'],
    defaultSuites: ['DEV', 'RELEASE'],
    shard: 'B',
    operation: 'phase3k-guided-constellation-worker',
  }),
  gate({
  ...
  gate({
    id: 'C-phase3j-strict-guide-visible-constellation',
    version: 1,
    phase: '3J',
    title: 'Strict Simple Craft Instructions, consolidated evidence, and always-visible Constellation',
    tags: ['phase3j', 'optimizer-ui', 'worker', 'craft-plan', 'share-export', 'constellation', 'responsive', 'accessibility'],
    fixtureIds: ['phase3c_primordial_renewal_rotten_claws'],
    costClass: 'SOLVER_HEAVY',
    isolation: 'SELF_CONTAINED',
    dependencies: ['A-phase3j-player-rule-direct'],
    sourceAreas: ['optimizer-ui', 'craft-plan', 'share-bundle', 'constellation', 'responsive-css'],
    defaultSuites: [],
    shard: 'C',
    operation: 'phase3j-strict-guide-visible-constellation',
  }),
  gate({
    id: 'C-phase3k-guided-constellation-browser',
    version: 1,
    phase: '3K',
    title: 'Always-visible guided route, explanatory detail, copy/evidence, technical graph preservation, and responsive browser contract',
    tags: ['phase3k', 'guided-constellation', 'optimizer-ui', 'worker', 'share-export', 'constellation', 'responsive', 'accessibility', 'visual'],
    fixtureIds: ['three_notable'],
    costClass: 'SOLVER_HEAVY',
    isolation: 'SELF_CONTAINED',
    dependencies: ['A-phase3k-guided-constellation-direct'],
    sourceAreas: ['optimizer-ui', 'craft-plan', 'share-bundle', 'constellation', 'responsive-css'],
    defaultSuites: ['RELEASE'],
    shard: 'C',
    operation: 'phase3k-guided-constellation-browser',
  }),
  gate({
    id: 'C-phase3l-editor-reliability-browser',
    version: 1,
    phase: '3L',
    title: 'Portaled modifier geometry, keyboard and pointer ownership, and acceptable-alternative validation lifecycle',
    tags: ['phase3l', 'optimizer-ui', 'target', 'responsive', 'accessibility', 'visual'],
    fixtureIds: [],
    costClass: 'FAST',
    isolation: 'SELF_CONTAINED',
    dependencies: ['A-phase3l-ui-reliability-direct'],
    sourceAreas: ['optimizer-ui', 'responsive-css', 'target-definition'],
    defaultSuites: ['DEV', 'RELEASE'],
    shard: 'C',
    operation: 'phase3l-editor-reliability-browser',
  }),
  gate({
    id: 'C-phase3l-constellation-print-browser',
    version: 1,
    phase: '3L',
    title: 'Unambiguous compact guided route, expected/provisional copy, and rendered print/PDF fidelity',
    tags: ['phase3l', 'guided-constellation', 'optimizer-ui', 'worker', 'print', 'visual'],
    fixtureIds: ['phase3c_primordial_renewal_rotten_claws'],
    costClass: 'SOLVER_HEAVY',
    isolation: 'SELF_CONTAINED',
    dependencies: ['A-phase3l-ui-reliability-direct'],
    sourceAreas: ['optimizer-ui', 'craft-plan', 'share-bundle', 'responsive-css'],
    defaultSuites: ['RELEASE'],
    shard: 'C',
    operation: 'phase3l-constellation-print-browser',
  }),
  gate({
