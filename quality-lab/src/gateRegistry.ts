...
export const QUALITY_GATE_REGISTRY: QualityGateDefinition[] = [
  ...
  gate({
    id: 'C-policy-family-admissibility',
    version: 1,
    phase: '3C',
    title: 'Real field Worker revalidates known Open policy inside constrained families',
    tags: ['phase3c', 'worker', 'solver', 'proof', 'method-family'],
    ...
    defaultSuites: ['DEV', 'RELEASE'],
    shard: 'C',
    operation: 'policy-family-admissibility',
  }),
  gate({
