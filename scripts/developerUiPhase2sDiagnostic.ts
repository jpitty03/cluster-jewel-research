...
assert.equal(result.presentation.schemaVersion, '2X.1');
...
assert(uiSource.includes("export const APP_RELEASE_VERSION = '2X.1'"));
...
lines.push('PASS: retained UI advances to Release Candidate 2X.1 and prominently distinguishes stale-pricing research estimates.');
