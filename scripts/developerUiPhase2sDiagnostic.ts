...
assert.equal(result.presentation.schemaVersion, '2Y.1');
...
assert(uiSource.includes("export const APP_RELEASE_VERSION = '2Y.1'"));
...
lines.push('PASS: retained UI advances to Release Candidate 2Y.1 and prominently distinguishes stale-pricing research estimates.');
